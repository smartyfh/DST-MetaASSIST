...
class MultiWozDataset(Dataset):
    def __init__(self, data, tokenizer, slot_meta, max_seq_length, rng,
                 ontology, word_dropout=0.1, shuffle_state=False, shuffle_p=0.5, use_pseudo_label=False):
        self.data = data
        self.len = len(data)
    ...
    def collate_fn(self, batch):
        ...
        if self.use_pseudo_label:
            ...
            return input_ids, input_mask, segment_ids, state_position_ids, op_ids, gen_ids, max_value, max_update
