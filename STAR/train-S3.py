...
import higher
import itertools
from models.WeightNet import WNet2 as WNet
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wnet_lr", default=3e-5, type=float)
    ...
    f'-sd{args.random_seed}-bz{args.train_batch_size}-{args.meta_batch_size}-lr{args.enc_lr}-{args.dec_lr}-{args.wnet_lr}-ep{args.n_epochs}'
