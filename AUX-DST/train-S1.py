...
def main(args):
    ...
    if args.do_train:
        ...
        sw_scheduler = get_linear_schedule_with_warmup(sw_optimizer, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sw_lr", default=1e-4, type=float)
    ...
    f'-sd{args.random_seed}-bz{args.train_batch_size}-{args.meta_batch_size}-lr{args.base_lr}-{args.sw_lr}-ep{args.n_epochs}'
